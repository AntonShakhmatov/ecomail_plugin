...
function ecomail_cf7_integration_section_callback_1() {
  echo 'Enter your Ecomail API information:';
  echo '<h3>List IDs</h3>';
  echo '<p>Set the List ID for each form:</p>';
}
...
function ecomail_custom_template_id_callback_1($args)
{
    ...
    echo '<input type="text" name="ecomail_list_id_' . $form_id . '_template_id_1" value="' . $fields_string . '" ><br>';
}
